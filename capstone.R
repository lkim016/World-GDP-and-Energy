...
# https://wriorg.s3.amazonaws.com/s3fs-public/global-power-plant-database-technical-note_0.pdf?_ga=2.57040810.1854731461.1543134756-498528150.1543134756

### other datasets:
# http://datasets.wri.org/dataset/cait-country-clean-technology-data
# kenya: http://datasets.wri.org/dataset/locations-of-proposed-small-micro-hydropower-sites-in-kenya
# paris: http://datasets.wri.org/dataset/85940e80-d6dd-4978-a2e6-82ca743b0884
# https://www.gapminder.org/data/
# https://github.com/awesomedata/awesome-public-datasets#energy
# storytelling: https://www.dataquest.io/blog/data-science-portfolio-project/

### geovis map
# https://developers.google.com/chart/interactive/docs/gallery/geochart
# https://rdrr.io/cran/googleVis/man/gvisGeoChart.html
...
### prediction
# https://www.dummies.com/programming/r/how-to-predict-new-data-values-with-r/

# cross validation
# http://www.milanor.net/blog/cross-validation-for-predictive-analytics-using-r/


# full process of data science
# https://www.analyticsvidhya.com/blog/2017/06/a-comprehensive-guide-for-linear-ridge-and-lasso-regression/
# https://www.r-bloggers.com/lasso-regression-in-r-exercises/
...
#tabItem(tabName = "interactive dynamic map",
# fluidRow(
...
tabItem(
  ...
  fluidPage(column(12, align = "center"
                   ...
                   sidebarLayout(
                     sidebarPanel(
                       conditionalPanel(
                         'input.dataset === "Final DF"'#,
                         #checkboxGroupInput("show_vars", "Columns in World Bank dataset to show:",
                         #                  names(final.df), selected = names(final.df))
                         
                       ),
                       conditionalPanel(
                         'input.dataset === "Pred DF"'#,
